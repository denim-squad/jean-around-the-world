...
===
#### TL;DR
*Jean Around the World* is a web app that allows users to plan trips anywhere in the world. Select a location anywhere on the map, and we will provide an itinerary for you based on your preferences!
